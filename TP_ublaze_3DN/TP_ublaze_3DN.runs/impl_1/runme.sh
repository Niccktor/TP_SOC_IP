...
HD_PWD='C:/Workspace/TP_SOC_IP/TP_ublaze_3DN/TP_ublaze_3DN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ublaze_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ublaze_system_wrapper.tcl -notrace
