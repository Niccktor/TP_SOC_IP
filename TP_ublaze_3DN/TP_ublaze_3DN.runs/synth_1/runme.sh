...
HD_PWD='C:/Workspace/TP_SOC_IP/TP_ublaze_3DN/TP_ublaze_3DN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ublaze_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ublaze_system_wrapper.tcl
