...
synth_design -top ublaze_system_wrapper -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef ublaze_system_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file ublaze_system_wrapper_utilization_synth.rpt -pb ublaze_system_wrapper_utilization_synth.pb"
