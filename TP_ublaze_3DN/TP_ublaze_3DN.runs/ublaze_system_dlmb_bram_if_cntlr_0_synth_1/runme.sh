...
HD_PWD='C:/Workspace/TP_ublaze_3DN/TP_ublaze_3DN.runs/ublaze_system_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ublaze_system_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ublaze_system_dlmb_bram_if_cntlr_0.tcl
