...
HD_PWD='C:/Workspace/TP_ublaze_3DN/TP_ublaze_3DN.runs/ublaze_system_rst_clk_wiz_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ublaze_system_rst_clk_wiz_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ublaze_system_rst_clk_wiz_0_100M_0.tcl
