...
HD_PWD='C:/Workspace/TP_ublaze_3DN/TP_ublaze_3DN.runs/ublaze_system_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ublaze_system_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ublaze_system_axi_gpio_0_1.tcl
